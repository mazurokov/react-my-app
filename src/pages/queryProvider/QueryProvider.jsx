...
function QueryProvider() {
  ...
  return (
    <section className="mx-auto max-w-6xl bg-white px-4 py-8 text-slate-900">
      <h2 className="text-xl font-bold mb-3">QueryProvider</h2>

      <nav className="flex flex-wrap gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-3 shadow-sm mb-2">
        <Link
